...
<div class="bookself-form-fields bookself-book-properties">
    <dl>
        ...
        <dt>
            <label for="bookself-book-rate"><?php esc_html_e('평가', 'bookself'); ?></label>
        </dt>
        <dd>
            <input
                id="bookself-book-rate"
                class="text"
                max="1"
                min="-1"
                name="<?php echo esc_attr($this->get('field')['rate'] ?? ''); ?>"
                type="number"
                value="<?php echo esc_attr($this->get('value')['rate'] ?? ''); ?>"
            />
        </dd>
    </dl>
</div>
<?php wp_nonce_field('bookself-book-properties', '_bookself_book_properties', false); ?>
